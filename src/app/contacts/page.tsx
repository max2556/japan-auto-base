      ...
      <section className="max-w-5xl mx-auto space-y-4 -mt-10 px-4 lg:px-11">
        <div className="lg:pr-6 space-y-1">
          ...
          <p className="max-w-[37.5rem] text-sm leading-4 mt-1">
            Мы, JapanAutoBase - продаем автомобили из Японии с 2016 года,
            продали более 1000 автомобилей, помогаем пройти через все этапы
            покупки и доставки авто прям в ваши руки.
          </p>
        </div>
